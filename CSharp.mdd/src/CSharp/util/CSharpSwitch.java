...
public class CSharpSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CSharpPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CSharpPackage.NAMESPACE: {
			...
			case CSharpPackage.CLASS_MEMBER: {
			...
			case CSharpPackage.CLASS: {
				CSharp.Class class_ = (CSharp.Class)theEObject;
			...
			case CSharpPackage.PRIMITIVE_TYPE: {
			...
			case CSharpPackage.ENUMERATION: {
			...
			case CSharpPackage.ENUMERATION_LITERAL: {
			...
			case CSharpPackage.METHOD_PARAMETER: {
	 ...
	 * @generated
	 */
	public T caseClass(CSharp.Class object) {
		return null;
	}
