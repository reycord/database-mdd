 ...
 * <ul>
 *   <li>{@link CSharp.impl.ModelImpl#getName <em>Name</em>}</li>
 *   <li>{@link CSharp.impl.ModelImpl#getOwnedMember <em>Owned Member</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends EObjectImpl implements Model {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSharpPackage.MODEL__NAME, oldName, name));
	}
	...
	public EList<Element> getOwnedMember() {
		if (ownedMember == null) {
			ownedMember = new EObjectContainmentWithInverseEList<Element>(Element.class, this, CSharpPackage.MODEL__OWNED_MEMBER, CSharpPackage.ELEMENT__OWNING_MODEL);
		}
		return ownedMember;
	}
