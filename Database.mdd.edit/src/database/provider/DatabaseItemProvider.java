...
/**
 * This is the item provider adapter for a {@link database.Database} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DatabaseItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DatabasePackage.Literals.DATABASE__DB_FK);
			childrenFeatures.add(DatabasePackage.Literals.DATABASE__DB_TABLE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DatabasePackage.Literals.DATABASE__DB_FK,
				 DatabaseFactory.eINSTANCE.createForeignKey()));

		newChildDescriptors.add
			(createChildParameter
				(DatabasePackage.Literals.DATABASE__DB_TABLE,
