...
public class Generate extends AbstractAcceleoGenerator {
    ...
    resourceSet.getPackageRegistry().put(CSharp.CSharpPackage.eINSTANCE.getNsURI(), CSharp.CSharpPackage.eINSTANCE);
    resourceSet.getPackageRegistry().put(CSharp.PrimitiveTypes.PrimitiveTypesPackage.eINSTANCE.getNsURI(), CSharp.PrimitiveTypes.PrimitiveTypesPackage.eINSTANCE);
