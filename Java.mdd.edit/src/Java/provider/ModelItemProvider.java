...
/**
 * This is the item provider adapter for a {@link Java.Model} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JavaPackage.Literals.MODEL__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JavaPackage.Literals.MODEL__OWNED_MEMBER);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Model.class)) {
			case JavaPackage.MODEL__NAME:
				...
				return;
			case JavaPackage.MODEL__OWNED_MEMBER:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.Literals.MODEL__OWNED_MEMBER,
		...
		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.Literals.MODEL__OWNED_MEMBER,
				 JavaFactory.eINSTANCE.createEnumerationLiteral()));

		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.Literals.MODEL__OWNED_MEMBER,
				 JavaFactory.eINSTANCE.createMethodParameter()));
	}
