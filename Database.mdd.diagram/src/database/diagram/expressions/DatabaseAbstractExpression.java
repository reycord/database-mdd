 ...
 * @generated
 */
public abstract class DatabaseAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = DatabaseDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected DatabaseAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
