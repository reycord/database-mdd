...
import database.diagram.edit.policies.DatabaseCanonicalEditPolicy;
import database.diagram.edit.policies.DatabaseItemSemanticEditPolicy;
...
public class DatabaseEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "Database"; //$NON-NLS-1$
