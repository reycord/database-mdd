 ...
 * @generated
 */
public class DatabaseBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected DatabaseBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						DatabaseVisualIDRegistry.getVisualID((View) view));
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		if (editPolicyCommand != null) {
			...
			request.setParameter(DatabaseBaseEditHelper.EDIT_POLICY_COMMAND,
					command);
		}
		IElementType requestContextElementType = getContextElementType(request);
		request.setParameter(DatabaseBaseEditHelper.CONTEXT_ELEMENT_TYPE,
				requestContextElementType);
		ICommand command = requestContextElementType.getEditCommand(request);
		request.setParameter(DatabaseBaseEditHelper.EDIT_POLICY_COMMAND, null);
		request.setParameter(DatabaseBaseEditHelper.CONTEXT_ELEMENT_TYPE, null);
		if (command != null) {
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = DatabaseElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = DatabaseDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			DatabaseDiagramEditorPlugin.getInstance().setLinkConstraints(
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public boolean canCreateForeignKey_4001(Database container,
				Table source, Table target) {
			return canExistForeignKey_4001(container, null, source, target);
		}
