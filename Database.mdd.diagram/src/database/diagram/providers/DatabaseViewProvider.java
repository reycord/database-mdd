 ...
 * @generated
 */
public class DatabaseViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = DatabaseVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = DatabaseVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!DatabaseElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != DatabaseVisualIDRegistry
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = DatabaseVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != DatabaseVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = DatabaseVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = DatabaseVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case TableEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (DatabaseVisualIDRegistry.getVisualID(elementTypeHint)) {
	...
	public Node createTable_2001(EObject domainElement, View containerView,
		...
		node.setType(DatabaseVisualIDRegistry.getType(TableEditPart.VISUAL_ID));
	...
	public Node createColumn_3001(EObject domainElement, View containerView,
		...
		node.setType(DatabaseVisualIDRegistry.getType(ColumnEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		return node;
	}
	...
	public Edge createForeignKey_4001(EObject domainElement,
		...
		edge.setType(DatabaseVisualIDRegistry
