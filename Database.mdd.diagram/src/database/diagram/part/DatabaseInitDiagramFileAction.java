 ...
 * @generated
 */
public class DatabaseInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new DatabaseNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				DatabaseEditPart.MODEL_ID));
		DatabaseDiagramEditorUtil.runWizard(getShell(), wizard,
