...
public class Generate extends AbstractAcceleoGenerator {
    ...
    resourceSet.getPackageRegistry().put(Java.JavaPackage.eINSTANCE.getNsURI(), Java.JavaPackage.eINSTANCE);
    resourceSet.getPackageRegistry().put(Java.PrimitiveTypes.PrimitiveTypesPackage.eINSTANCE.getNsURI(), Java.PrimitiveTypes.PrimitiveTypesPackage.eINSTANCE);
