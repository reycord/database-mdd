...
/**
 * This is the item provider adapter for a {@link CSharp.Field} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FieldItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Field_initializer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Field_initializer_feature", "_UI_Field_type"),
				 CSharpPackage.Literals.FIELD__INITIALIZER,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Field.class)) {
			case CSharpPackage.FIELD__INITIALIZER:
