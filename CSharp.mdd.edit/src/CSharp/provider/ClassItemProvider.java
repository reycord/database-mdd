...
/**
 * This is the item provider adapter for a {@link CSharp.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addActualTypeParametersPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CSharpPackage.Literals.CLASS__IS_ABSTRACT,
				 true,
				 false,
				 false,
	...
	protected void addIsPublicPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Class_isPublic_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Class_isPublic_feature", "_UI_Class_type"),
				 CSharpPackage.Literals.CLASS__IS_PUBLIC,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CSharpPackage.Literals.CLASS__IS_INTERFACE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CSharpPackage.Literals.CLASS__SUPER_CLASSES,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Actual Type Parameters feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addActualTypeParametersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Class_actualTypeParameters_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Class_actualTypeParameters_feature", "_UI_Class_type"),
				 CSharpPackage.Literals.CLASS__ACTUAL_TYPE_PARAMETERS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIsPartialPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Class_isPartial_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Class_isPartial_feature", "_UI_Class_type"),
				 CSharpPackage.Literals.CLASS__IS_PARTIAL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CSharpPackage.Literals.CLASS__MEMBERS);
		}
	...
	public String getText(Object object) {
		String label = ((CSharp.Class)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CSharp.Class.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CSharpPackage.Literals.CLASS__MEMBERS,
				 CSharpFactory.eINSTANCE.createField()));

		newChildDescriptors.add
			(createChildParameter
				(CSharpPackage.Literals.CLASS__MEMBERS,
				 CSharpFactory.eINSTANCE.createMethod()));
	}
