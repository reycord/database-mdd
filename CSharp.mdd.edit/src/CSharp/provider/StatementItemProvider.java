...
/**
 * This is the item provider adapter for a {@link CSharp.Statement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CSharpPackage.Literals.STATEMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addBodyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Statement_body_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Statement_body_feature", "_UI_Statement_type"),
				 CSharpPackage.Literals.STATEMENT__BODY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
