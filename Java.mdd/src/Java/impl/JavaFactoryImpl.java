...
public class JavaFactoryImpl extends EFactoryImpl implements JavaFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case JavaPackage.ENUMERATION_LITERAL: return createEnumerationLiteral();
			case JavaPackage.METHOD_PARAMETER: return createMethodParameter();
	 ...
	 * @generated
	 */
	public Java.Package createPackage() {
