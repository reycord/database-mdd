...
public class JavaSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case JavaPackage.PACKAGE: {
				Java.Package package_ = (Java.Package)theEObject;
				T result = casePackage(package_);
				if (result == null) result = caseElement(package_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JavaPackage.CLASS_MEMBER: {
				ClassMember classMember = (ClassMember)theEObject;
				T result = caseClassMember(classMember);
				if (result == null) result = caseElement(classMember);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JavaPackage.FIELD: {
				...
				if (result == null) result = caseClassMember(field);
			...
			case JavaPackage.CLASS: {
				Java.Class class_ = (Java.Class)theEObject;
			...
			case JavaPackage.ENUMERATION_LITERAL: {
			...
			case JavaPackage.METHOD_PARAMETER: {
				...
				if (result == null) result = caseElement(methodParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T casePackage(Java.Package object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseClass(Java.Class object) {
		return null;
	}
